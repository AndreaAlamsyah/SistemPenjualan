...
<head>
  ...
  <title>PenjualanKu - Landing Page</title>
        ...
        <div class="container box_1620">
          ...
          <div class="collapse navbar-collapse offset" id="navbarSupportedContent">
            ...
            <div class="nav-right text-center text-lg-right py-4 py-lg-0 d-flex">
              <a class="button mt-8 mb-8" href="{{ url('/login') }}">Login</a>
              <a href="{{ url('/register') }}" style="background: #f5365c;" class="button ml-8 mt-8 mb-8">Sign Up</a>
            </div>
            <br>
          </div> 
        </div>
    ...
    <div class="container">
      ...
      <div class="row align-items-center text-center text-md-left">
        <div class="col-md-8 col-lg-5 mb-5 mb-md-0">
          <h1>PenjualanKu</h1><br>
          <h1>Kelola Penjualanmu</h1>
          <p>
          	PenjualanKu, Data penjualan, Data Transaksi, Riset Penjualan dan Kebutuhan Lain terkait Penjualan. 
          </p>
          <a class="button button-hero mt-4" style="background: #f5365c;" href="{{ url('/register') }}">Join Now!</a>
        </div>
        <div class="col-md-8 col-lg-7 col-xl-8 offset-xl-1">
